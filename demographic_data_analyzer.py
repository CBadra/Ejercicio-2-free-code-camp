...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_data = df.groupby('native-country')['salary'].value_counts(normalize=True).unstack()['>50K'] * 100
    highest_earning_country = highest_earning_country_data.idxmax()
    highest_earning_country_percentage = round(highest_earning_country_data.max(), 1)
